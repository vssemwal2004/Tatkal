...
const eventBookings = [
  { id: 'EV-204', route: 'Mumbai • Stadium Night', status: 'Completed', date: 'Apr 12, 2026' },
  { id: 'EV-219', route: 'Pune • Indie Fest', status: 'Refunded', date: 'Apr 16, 2026' },
  { id: 'EV-233', route: 'Delhi • Art Gala', status: 'Upcoming', date: 'Apr 24, 2026' }
];

const HistoryPreview = ({ config, project }) => {
  const isEvent = project?.businessType === 'event';
  const bookings = isEvent ? eventBookings : travelBookings;
  const routeLabel = isEvent ? 'Event' : 'Route';
