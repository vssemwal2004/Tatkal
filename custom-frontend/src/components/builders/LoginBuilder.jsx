...
const LoginBuilder = ({ config, updateSection }) => (
  <div className="space-y-5">
    <ControlSection
      subtitle="Define the first impression of your booking platform."
    ...
    >
      ...
      <TextField
        label="Headline"
        onChange={(headline) => updateSection({ headline })}
    ...
    <ControlSection subtitle="Control which sign-up fields are visible." title="Signup Form">
      <ToggleField
        checked={config.signUpName}
        label="Name"
        onChange={(signUpName) => updateSection({ signUpName })}
      />
      <ToggleField
    ...
    <ControlSection subtitle="Use RGB-friendly theme values for a premium dark layout." title="Colors">
      <ColorField
